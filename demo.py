...
def run():
    ...
    tl.init()
    while True:
        tl.time = tl.now() + 100_000_000_000
        ...
        if n1_memo.entangled_memory["node_id"] is not None:
            break

    # print("before", n1_memo.entangled_memory, n1_memo.fidelity)
    print(
        "after",
        n1_memo.entangled_memory,
        n1_memo.fidelity,
        n1.resource_manager.ent_count,
        n1.resource_manager.raw_count,
    )
